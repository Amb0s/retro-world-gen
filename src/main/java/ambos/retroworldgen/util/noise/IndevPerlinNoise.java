...
public final class IndevPerlinNoise extends Noise {
    ...
    public IndevPerlinNoise(Random random) {
    ...
    public double sample(double d, double d1, double d2) {
        ...
        d = (MathsHelper.floor(d4) & 0xFF);
        double i = MathsHelper.floor(d5) & 0xFF;
        d1 = (MathsHelper.floor(d6) & 0xFF);
        d4 -= MathsHelper.floor(d4);
        d5 -= MathsHelper.floor(d5);
        d6 -= MathsHelper.floor(d6);
        double d7 = method_1204(d4);
        double d8 = method_1204(d5);
        double d9 = method_1204(d6);
        double j = this.permutations[(int) d] + i;
        d2 = this.permutations[(int) j] + d1;
        j = this.permutations[(int) j + 1] + d1;
        d = this.permutations[(int) d + 1] + i;
        i = this.permutations[(int) d] + d1;
        d = this.permutations[(int) d + 1] + d1;
        return method_1203(d9, method_1203(d8, method_1203(d7, method_1201(this.permutations[(int) d2], d4, d5, d6), method_1201(this.permutations[(int) i], d4 - 1.0, d5, d6)), method_1203(d7, method_1201(this.permutations[(int) j], d4, d5 - 1.0, d6), method_1201(this.permutations[(int) d], d4 - 1.0, d5 - 1.0, d6))), method_1203(d8, method_1203(d7, method_1201(this.permutations[(int) d2 + 1], d4, d5, d6 - 1.0), method_1201(this.permutations[(int) i + 1], d4 - 1.0, d5, d6 - 1.0)), method_1203(d7, method_1201(this.permutations[(int) j + 1], d4, d5 - 1.0, d6 - 1.0), method_1201(this.permutations[(int) d + 1], d4 - 1.0, d5 - 1.0, d6 - 1.0))));
    }
    
    public double method_1204(double d) {
